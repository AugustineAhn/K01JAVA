...
/*
 Wrapper 클래스
 	...
 	-오토박싱: 기본자료형이 자동으로 참조형으로 변경되는것.
 		예] int => Integer
 	-오토언박싱: 참조형이 기본자료형으로자동 변경되는것.
 	오토박싱 언박싱은 jdk1.5 이상에서 지원
 */
public class E01WrapperClass1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("결과값을 byte 형 값으로 변경:" + 
				resultObj.byteValue());
		System.out.println("결과값을 이진수로변경: "+ 
				Integer.toBinaryString(result2));
	
		//jdk 1.5이후 버전에서의 코딩형태
		Integer numObj1 = 100;//오토박싱처리
		Integer numObj2 = 200;
		int num3 = numObj1;//오토언박싱처리
