...
public class Ex06Define1Predicate {
	...
	public static void main(String[] args) {
		...
		//두번째 호출: 매개변수 객체가 여자일 때 true를 반환하는 람다식 전달
		double femaleAvg = avg((Human b)-> b.getGender().equals("여"), list1);
		System.out.println("여자평균:" + maleAvg);
