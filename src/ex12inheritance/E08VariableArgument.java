...
//	
	...
	public static void main(String[] args) {
		...
		System.out.println("getToral(args1) 호출:" + getTotal(10));
		System.out.println("getToral(args1, args2) 호출:" + getTotal(10, 20));
		System.out.println("getToral(args1, args2, args3) 호출:" + getTotal(10, 20, 30));
		System.out.println("getToral(매개변수6개) 호출:" + getTotal(10,20,30,40,50,60));
