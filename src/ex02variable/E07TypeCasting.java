...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		...
		/*
		 자동형변환: 작은 상자의 데이터를 큰상자에 대입할 때 자동으로
		 형변환이 일어난다.
		 */
		byte b1 = 65;
		short s1;
		...
		/*
		 아래코드는 자동 형변환이 아님. CPU는 int보다 작은 자료형을
		...
		/*
		 명시적 형변환: 큰상자의 지료를 작은 상자의 자료형에 할당해야 할때
		 	사용한다. 단, 이때는 데이터의 손실이 있을 수 있으므로 주의를 
		 	요한다.
		 */
		short s2 = 100;
		byte b2 = (byte)s2;
		...
		/*
		 ...
		 경우가 아니라면 사용을 자제하는 것이 좋다.
		 */
		int num3;
		double dl = 3.14;
		num3 = (int)dl;
		System.out.printf("데이터손실:num3=%d, d1=%.2f %n",
				num3, dl);
		
		/*
		 char와 int를 연산하면 결과는 int를 반환하므로 char형 변수에
		 대입하려면 명시적 형변환 후 해야한다.
		 */
		char ch3 = 'A', ch4;
		int num4 = 2;
