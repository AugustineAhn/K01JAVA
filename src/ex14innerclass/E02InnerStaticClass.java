...
/*
 ...
 -외부클래스명$내부크래스명.class 파일이 생성된다.
 
* 원래 클래스 앞에는 static을 붙일 수 없으나 내부클래스에는 허용된다.
 */
class OuterClass {
	//인스턴스형 멤버변수
	...
	void outerMemberMethod() {
		/*
		 외부클래스의 멤버메소드에서는 내부 정적클래스의 멤버를 
		 접근할 수 있다.(Heap영역에서는 Method영역을 참조할
		 수 있다.)
		 */
	...
	static void outerStaticMethod() {
		...
		/*
		 ...
		 접근할 수 있다.(Method영역에서는Heap영역을 참조할 수 없다.)
		 */
	...
	static class InnerStaticClass{
		...
		void innerMemberMethod() {
			System.out.println("내부클래스의 멤버메소드호출");
		...
		static void innerStaticMethod() {
			System.out.println("내부클래스의 정적메소드호출");
		}
	}
}
public class E02InnerStaticClass {
	...
	public static void main(String[] args) {
		...
		/*
		 내부 정적클래스의 정적멤버에 접근할 때는 외부 클래스의 객체 생성없이
		 클래스명으로 바로 접근이 가능하다.
		 */
		...
		/*
		 내부 정적클래스의 인스턴스 멤버에 접근할 때는 객체를 
		 생성한 후 참조변수를 통해서 접근해야 한다.
		 */
		...
		/*
		 ...
		 외부클래스의 멤버변수(메소드)는 객체생성후 참조변숳를 통해 접근한다.
		 */
