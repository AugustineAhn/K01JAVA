...
public class DBConnection {
			...
			throws ClassNotFoundException, SQLException
	{
		...
		/*
		 2] 오라클에 연결하기 위한 커넥션 URL, 계정ID, 패스워드를 준비한다.
		 	커넥션URL =>
