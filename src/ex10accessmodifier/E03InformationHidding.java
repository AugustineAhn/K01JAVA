...
class FruitSeller{
	...
	//외부클래스에서 접근할 수 없도록 private으로 선언
	private int numOfApple ; //판매자의 사과 보유갯수
	private int myMoney ;//판매수익
	private final int APPLE_PRICE ;//다시 상수로 선언
...
public class E03InformationHidding {
...
//		buyer.numOfApple +=50;
//		
//		seller2.myMoney += 1000;//판메자2에게 1000을 지불하고
