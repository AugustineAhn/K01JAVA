...
class MemberRegist {
	void doMemberRegist() {
			...
			System.out.println("1. 회원가잆을 진행합니다.");
		}
	}
	...
	/*
	 업무의 순서를 고려하여 관련된 메소드를 하나의 클래스로 정의 하였다.
	 차후에는 별도의 분석작업없이 해당 클래스의 메소드만 호출하면
	 엄무는 오류없이 진행될 것이다.
	 */
	class EncapsulLogic {
	...
	public class E05Encapsulation {
		...
		public static void main(String[] args) {
			...
			/*
			 업무의 진행순서가 중요하다고 했을 때 캡슐화 이전의 코드
			 */
			System.out.println("캡술화 전 코드");
			MemberRegist memberRegist = new MemberRegist();
