...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 생성된 배열은 입(heap)영역에 저장되고, 할당된 메모리의
		 주소값을 반환하다. 그래서 배열명(배열변수)는 주소값(참조값)을 
		...
		/*
		 배열의 선언 및 초기화
		 	; 배열은 여러개의변수를 사용하기 위해 선언하므로
		 	접근을 위해 일반적으로 반복문을 사용한다.
		 배열명.length : 해당 배열의 크기를 반환한다. 배열의 크기가 변경되는
		 경우에 유연하게 사용할 수 있다.
		 */
		...
		/*
		 ...
		 초기값의 갯수를 통해 크기를 결정할 수 있으므로 이런 경우
		 크기는 생략하도록 약속되어있다.
		 */
		...
		/*
		 ...
		 new 키워드는 생략한다.
		 */
		System.out.println("배열요소의 합은=" + arrSum2);
