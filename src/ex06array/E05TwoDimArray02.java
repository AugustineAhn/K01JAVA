...
public class E05TwoDimArray02 {
	...
	public static void main(String[] args) {
		...
		/*
		 세로크기 3, 가로크기 4인 2차원 배열 선언.
		 */
		int[][] arr2Dim = new int[3][4];//선언
		
		/*
		 가로, 세로 크기 만큼 반복하면서 초기화 진행.
		 */
		for (int i = 0; i < 3; i++) {//세로배열 초기화
			for (int j = 0; j < 4; j++) {//가로배열 초기화
				arr2Dim[i][j] = i + j;//값 넣기
			}
	...
	/*
	 배열을 출력하는 부분이 중복되기 때문에 이런 경우 메소드를
	 생성하여 호출해 주는 것이 좋다.
	 */
