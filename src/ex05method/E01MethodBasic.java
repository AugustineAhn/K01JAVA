...
/*
 메소드의 규칙
 - Java에서는 main 메소드는 무조건 public static void로 
 	선언하기로 약속되어있다.
...
public class E01MethodBasic {
		...
		/*
		 메소드 정의2 : 반환타입 X, 매개변수 X 형태로 정의
		 -> 전달되는 값 없이 이름을 입력받은 후 namePrint()함수로 호출한다.
		 반환값이 없는 경우에는 반드시 void라고 명시해야 핞다.
		 */
