...
class SingleTone{
	...
	/*
	 생성자를 private으로 선언하면 클래스 외부에서는 접근할 수
	 ...
	 */
	public static SingleTone getInstance() {//객체형태도 반환할 수 있다.(싱글톤타입)
		return single;
	}
...
public class E03SingleToneDesignPattern {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 객체의 참조변수를 반환받을 수 있다.
		 */
		SingleTone st2 = SingleTone.getInstance();//이탤릭체-static
		st2.shareVar = 100;
		st2.print();
		...
		System.out.println(String.format("st2의 주소:%d", st2.shareVar));
		System.out.println(String.format("st3의 주소:%d", st3.shareVar));
