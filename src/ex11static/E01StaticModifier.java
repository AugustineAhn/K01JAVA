...
/*
 ...
 -정적변수는 JVM(자바가상머신)에 의해 프로그램이 로드되는 
 	시점에 초기화된다.
 -main메소드가 실행되기 전에 이미 초기화 되므로 main 메소드
 실행시 별도의 선언없이 변수를 사용할수있댜.
...
class MyStatic{
	...
	/*
	 ...
	 (※main메소드에서는 static으로 선언된 메소드만 호출할 수 
	 있었음을 기억하자)
	 */
...
public class E01StaticModifier {
	...
	public static void main(String[] args) {
		...
		System.out.println("ms1.intanceVar=" + ms1.instanceVar);//100
		System.out.println("ms2.intanceVar=" + ms2.instanceVar);//1000
		...
		*/
		...
		//MyStatic.instastnceMethod();//에러발생(참조변수를 통해서만 호출 가능)
		MyStatic.staticMethod();
