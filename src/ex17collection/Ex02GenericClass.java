...
=> 기존 Object기반의 FruitBox를 아래와 같이 제너릭 클래스로 정의한다.
자료형에 해당하는 대분을 대표문자T(Type)으로 교체하고 , 객체생성시
...
public class Ex02GenericClass {
	...
	public static void main(String[] args) {
		...
		/*
		 OrangeBox는 인스턴스 생성시 Orange를 저장 할 수 있는 용도로
		 생성도었기 때문에 다른 객체는 저장할 수 없다. 아래 코드에서
		 컴파일 에러가 발생되므로 자료형에도 안전한 코드가 된다.
		 */
