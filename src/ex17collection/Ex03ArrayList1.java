	...
	public static void main(String[] args) {
		...
		/*
		 List<E> 인터페이스 계열의 컬렉션
		 	: ArrayList<T>와 같은 컬렉션은 제너릭을 기반으로 하지만
		 	아래와 같이 <T> 부분을 생략하면 모든 객체를 저장할 수 있는 
		...
		list.add("트와이스");
		list.add(3,"워너원");
		//list.add(5,"소방차 ㅋㅋ");//에러발생. 인덱스는 건너뛸수 없다.
		...
		/*
		 Iterator 사용법
		 -컬렉션에 저장된 내용을 Iterator 에게 알려주기 위해
		 객체를 생성한다.
		...
		System.out.println(list.contains("블랙핑크")? "블랙핑크 있음": "블랙핑크없음");


		/*
		 1-7] 삭제
		 방법1: 인덱스로 삭제하기
		     remove(인덱스) : 인덱스를 통해서 삭제를 진행
		 */
