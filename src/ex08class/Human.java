...
public class Human {
	...
	//행동을 표현하는 멤버메소드: 걷다, 생각하다, 먹다, 객체의 현재 상태 표현
	void walk() {
		...
		if (energy<0) {
			...
			System.out.println("[walk]에너지는 1 감소하였습니다.");
		}
	}
	...
	void thinking() { 
		...
		if (energy<0) {
			...
			System.out.println("[thinking]에너지는 2 감소하였습니다.");
		}
		
	}
	void eat() {
		//에너지를 2 증가 시킨 후 10을 초과하면 10으로 고정시킨다.
		energy+=2;
		if (energy>10) {
			energy = 10;
